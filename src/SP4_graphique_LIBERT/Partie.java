        ...
        do{
            ...
            do{
                ...
                switch(action){
                    ...
                    case 1 :
                        System.out.println("Veuillez choisir la colonne dans laquelle insérer votre jeton\n");
                        do{
                        ...
                        if (colonne<0 || colonne >6 || this.Plateau.colonneRemplie(colonne)){
                            System.out.println("Le numéro de colonne choisi n'est pas compatible avec la grille en cours veuillez saisir un nouveau numéro");
                        }
                        else{
                    ...
                    case 2 :
                        do{
                            ...
                            System.out.println("Veuillez saisir le numéro de ligne du jeton à retirer");
                            ligne=sc.nextInt();
                            System.out.println("Veuillez saisir le numéro de colonne du jeton à retirer");
                            colonne=sc.nextInt();
                            ...
                            if (ligne<0 || ligne>5 || colonne<0 ||colonne>6){
                                ...
                                if (!this.Plateau.presenceJeton(ligne, colonne) || this.Plateau.lireCouleurJeton(ligne, colonne)!=this.JoueurCourant.lireCouleur()){
                                    System.out.println("La cellule sélectionnée ne contient pas de jeton ou contient un jeton de l'autre joueur. Veuillez recommencer votre saisie.");
                                }
                                else{
                    ...
                    case 3 :
                        ...
                        if (this.JoueurCourant.nombreDesintegrateurs()==0){
                            System.out.println("Vous n'avez pas de Désintégrateur en votre possession. Veuillez choisir une autre action.");
                            ...
                            do{
                                                            //Recueuille les coordonées du jeton
                                System.out.println("Veuillez saisir le numéro de ligne du jeton à désintégrer");
                                ligne=sc.nextInt();
                                System.out.println("Veuillez saisir le numéro de colonne du jeton à désintégrer");
                                colonne=sc.nextInt();
                                                            //Vérification que les coordonnées saisies soient compatible
                                if (ligne<0 || ligne>5 || colonne<0 ||colonne>6){
                                    System.out.println("Le numéro de ligne ou de colonne saisie est incorrect veuillez recommencer votre saisie");
                                    ...
                                    //Teste si la cellule ne contient pas un mauvais élément
                                    if (!this.Plateau.presenceJeton(ligne, colonne) || this.Plateau.lireCouleurJeton(ligne, colonne)==this.JoueurCourant.lireCouleur()){
                                        System.out.println("La cellule sélectionnée ne contient pas de jeton ou contient un jeton de votre couleur. Veuillez recommencer votre saisie.");
                                    }
                                    else{
