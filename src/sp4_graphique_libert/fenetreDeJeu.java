...
public class fenetreDeJeu extends javax.swing.JFrame {
    ...
    public fenetreDeJeu() {
        ...
        for (int i = 5; i >= 0; i--) {
            for (int j = 0; j < 7; j++) {
                CelluleGraphique CelluleGraph = new CelluleGraphique(Plateau.grille[i][j]);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_col_0, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 20, -1, -1));
        ...
        getContentPane().add(btn_col_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(184, 20, -1, -1));
        ...
        getContentPane().add(btn_col_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, -1, -1));
        ...
        getContentPane().add(btn_col_3, new org.netbeans.lib.awtextra.AbsoluteConstraints(376, 20, -1, -1));
        ...
        getContentPane().add(btn_col_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(472, 20, -1, -1));
        ...
        getContentPane().add(btn_col_5, new org.netbeans.lib.awtextra.AbsoluteConstraints(568, 20, -1, -1));
        ...
        getContentPane().add(btn_col_6, new org.netbeans.lib.awtextra.AbsoluteConstraints(664, 20, -1, -1));
